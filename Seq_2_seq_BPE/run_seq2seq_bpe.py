...
def prepare_model(opt):
    ...
    model = HierAttNet(opt.word_hidden_size, opt.batch_size, training_set.num_classes, opt.num_sentences, opt.left_context_only, device)
