...
#SBATCH --gres=gpu:4
#SBATCH --mem=64G
#SBATCH --job-name=job_sa_seq2seq_cont_both_bpe_5
#SBATCH --output=class_sa_seq2seq_cont_both_bpe_5.out
#SBATCH --error=error_sa_seq2seq_cont_both_bpe_5.out
...
export MODEL_INFO=context_2_seqseq_both_bpe
